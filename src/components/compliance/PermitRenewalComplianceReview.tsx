...
export function PermitRenewalComplianceReview() {
        ...
        <CardContent className="space-y-4 pt-6">
          <div className="space-y-2">
            ...
            <Select value={complianceStatus} onValueChange={setComplianceStatus}>
              ...
              <SelectContent>
                <SelectItem value="approve">Approve Renewal - Compliant</SelectItem>
                <SelectItem value="conditional_approval">Conditional Approval</SelectItem>
                <SelectItem value="requires_inspection">Requires Compliance Inspection</SelectItem>
                <SelectItem value="verify_corrective_actions">Verify Corrective Actions</SelectItem>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Assess compliance history, verify corrective actions, review monitoring records, and provide recommendations..."
              rows={6}
            />
          </div>
