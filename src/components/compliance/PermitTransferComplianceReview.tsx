...
export function PermitTransferComplianceReview() {
        ...
        <CardContent className="space-y-4 pt-6">
          <div className="space-y-2">
            ...
            <Select value={complianceStatus} onValueChange={setComplianceStatus}>
              ...
              <SelectContent>
                <SelectItem value="approve">Approve Transfer - Compliant</SelectItem>
                <SelectItem value="conditional_approval">Conditional Approval</SelectItem>
                <SelectItem value="verify_transferee_capacity">Verify Transferee Capacity</SelectItem>
                <SelectItem value="outstanding_compliance_issues">Outstanding Compliance Issues</SelectItem>
                <SelectItem value="reject">Reject - Compliance Concerns</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Verify current permit compliance status, assess transferee's environmental management capacity, review outstanding obligations, and provide recommendations..."
              rows={6}
            />
          </div>
